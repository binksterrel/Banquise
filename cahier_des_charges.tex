...
\fancyhead[R]{Banquise}
\fancyfoot[C]{\thepage}

% Couleurs personnalisées
\definecolor{banquiseblue}{RGB}{0,102,204}
...
\begin{tikzpicture}[remember picture,overlay]
    \fill[banquiseblue!5] (current page.south west) rectangle (current page.north east);
    \fill[banquiseblue!20] ([xshift=-2cm,yshift=-2cm]current page.north east) circle (6cm);
    \fill[banquiseblue!10] ([xshift=1cm,yshift=1cm]current page.south west) circle (5cm);
\end{tikzpicture}

\begin{center}
    \vspace*{2cm}
    {\Large\textsc{Université Paris Nanterre}}\\[0.8cm]
    {\huge\bfseries Cahier des Charges}\\[0.4cm]
    {\Large\bfseries Banquise — Plateforme de Néobanque Web}\\[0.6cm]
    \rule{0.6\linewidth}{0.4pt}\\[0.6cm]
    {\large Version du \today}\\[2.5cm]

    \begin{tabular}{p{3cm}p{9cm}}
        \textbf{Projet} : & Banquise (Django 4.2) \\
    ...
    \vfill
    \textit{Un système bancaire numérique complet : comptes, cartes, virements, abonnements, crédits avec scoring IA, notifications et back-office admin.}
\end{center}
\end{titlepage}
...
Ce document constitue le cahier des charges du projet Banquise, une plateforme de néobanque web développée avec Django. L'objectif est de fournir une expérience bancaire digitale claire, sécurisée et complète, permettant la gestion de comptes, cartes, virements, abonnements, crédits avec scoring automatique, notifications et support client.
...
\begin{itemize}[leftmargin=1.5cm]
    \item Gestion multi-comptes (courant, épargne, professionnel)
    \item Cartes bancaires virtuelles avec contrôle total
    \item Système de virements instantanés
    \item Abonnements flexibles (Essentiel, Plus, Infinite)
    \item Simulation et demande de crédit avec scoring IA
