...
\section{Modèle ML simplifié (runtime)}
...
\paragraph{}Parcours classique d'inscription/connexion avec sécurisation des sessions, récupération de mot de passe et gestion du profil. Les rôles (client/staff) conditionnent l'accès aux écrans admin.
\begin{itemize}[leftmargin=1.5cm]
...
\paragraph{}Le client ouvre/ferme des comptes (courant, épargne, pro), consulte soldes et relevés paginés, et exporte ses relevés ou RIB. Les opérations sont historisées.
\begin{itemize}[leftmargin=1.5cm]
...
\paragraph{}Un simulateur de crédit calcule score/DTI/LTV, affiche un avis automatique, l’historique et permet à l’admin de valider/refuser. La page résultat propose une suggestion de durée/mensualité si le DTI est trop élevé.
\begin{itemize}[leftmargin=1.5cm]
